...
hidden if the `sawd_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sawd_DEVELOPER_MODE` to the configure
...
Runs the executable target `sawd_exe`.
